...
export const api = {
  ...
  runTask: (taskId: string, demoMode = "normal", autoRework = false) =>
    request(`/api/tasks/${taskId}/run?demo_mode=${encodeURIComponent(demoMode)}&auto_rework=${autoRework}`, { method: "POST" }),
